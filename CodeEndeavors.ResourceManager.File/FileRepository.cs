...
namespace CodeEndeavors.ResourceManager.File
{
    public class FileRepository : IRepository, IDisposable
    {
        ...
        public void Initialize(Dictionary<string, object> connection)
        {
            ...
            _cacheName = _connection.GetSetting("cacheName", "");
        ...
        public List<T> All<T>()
        {
            ...
            Func<List<T>> getDelegate = delegate()
                    {
            ...
            return CodeEndeavors.Distributed.Cache.Client.Service.GetCacheEntry(_cacheName, "FileRepository." + fileName, getDelegate, getMonitorOptions(fileName));
        }
        ...
        public ConcurrentDictionary<string, DomainObjects.Resource<T>> AllDict<T>()
        {
            ...
            return CodeEndeavors.Distributed.Cache.Client.Service.GetCacheEntry(_cacheName, "FileRepository." + fileName + ".Dict", getDelegate, getMonitorOptions(fileName));
        }
